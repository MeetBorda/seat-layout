...
const MainStage = memo(
  (props) => {
    ...
    const redrawStuff = () => {
      //   clearCacheExtensively()
      //   seatBgLayerRef.current.destroyChildren()
      //   drawChildren()
      //   cacheChildren()
      //   console.log(seatBgLayerRef.current.children)
      seatBgLayerRef.current.destroyChildren();
      staticLayerRef.current.destroyChildren();
      drawChildren();
      cacheChildren();
    };
    ...
    const cacheChildren = () => {
      //   seatBgLayerRef.current.cache()
      //   seatBgLayerRef.current.destroyChildren()
      stageRef2.current.children.cache();
      console.log(stageRef2.current.children);
      //   seatBgLayerRef.current.destroyChildren()
      //   seatBgLayerRef.current.children.cache()
      //   console.log(seatBgLayerRef.current.children)
      //   seatBgLayerRef.current.children.forEach((xa, ya) => {
      //     const { attrs } = xa
      //     const { x, y } = xa
